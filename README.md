![Banner](https://github.com/IsaiasVillegas/assets/blob/main/IsaiasVillegas.png?raw=true)
...
* 🎯 Enfoque en usabilidad, claridad visual y buenas prácticas
* 📚 Formación autodidacta con aprendizaje constante
* 🤝 Interés en colaborar en equipos y proyectos reales
...
🔗[Demo](https://isaiasvillegas.github.io/Blogr-landing-page/) 
📂[Código](https://github.com/IsaiasVillegas/Blogr-landing-page)
